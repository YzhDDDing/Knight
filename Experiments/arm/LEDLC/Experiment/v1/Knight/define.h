...
extern float Data_StoreMemory_Data[64];
...
extern int Data_StoreMemory6_Satisfied[64];
extern float Data_StoreMemory7_State;
extern float Data_StoreMemory8_Data_o[64];
extern int Data_StoreMemory9_Sat_o[64];

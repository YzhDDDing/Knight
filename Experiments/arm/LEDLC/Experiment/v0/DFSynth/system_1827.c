#include "define.h"
float Data_StoreMemory_Data[256];
...
int Data_StoreMemory6_Satisfied[256];
float Data_StoreMemory7_State;
float Data_StoreMemory8_Data_o[256];
int Data_StoreMemory9_Sat_o[256];
...
void system_1827_Update(struct system_1827_state* self, float t, int* Output) {
    int FunctionCallSubsystem2_Output;

...
void system_1441_Update(struct system_1441_state* self, int FindP, int P1, int P2, int P3) {
    ...
    for (int i = 0; i < 128; i++) {
        ...
        int batchIndex;
        for (batchIndex = 0; batchIndex < 128; batchIndex++) {
            Add2_DefaultOutport1[batchIndex] = Assignment_DefaultOutport1[batchIndex] + Switch4_DefaultOutport1;
        }
        ...
        if (Assignment1_init == 0) {
            ...
            for (batchIndex1 = 0; batchIndex1 < 128; batchIndex1++) {
                Assignment1_DefaultOutport1[batchIndex1] = Data_StoreRead2_DefaultOutport1[batchIndex1];
            }
        }
        Assignment1_DefaultOutport1[For_Iterator_DefaultOutport1] = Switch1_DefaultOutport1;
        int batchIndex1;
        for (batchIndex1 = 0; batchIndex1 < 128; batchIndex1++) {
            Product2_DefaultOutport1[batchIndex1] = (int)((int)rate2_DefaultOutport1 * Add2_DefaultOutport1[batchIndex1]);
        }
        int batchIndex2;
        for (batchIndex2 = 0; batchIndex2 < 128; batchIndex2++) {
            Add1_DefaultOutport1[batchIndex2] = Assignment1_DefaultOutport1[batchIndex2] + Switch4_DefaultOutport1;
        }

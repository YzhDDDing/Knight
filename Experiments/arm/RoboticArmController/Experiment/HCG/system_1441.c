...
void system_1441_Update(struct system_1441_state* self, int FindP, int P1, int P2, int P3) {
    ...
    for (int i = 0; i < 128; i++) {
        ...
        float32x4_t rate2_DefaultOutport1_Batch = vdupq_n_f32(rate2_DefaultOutport1);
        int batchIndex = 0;
        for (batchIndex = 0;batchIndex < 128;batchIndex += 4) {
            int32x4_t Assignment_DefaultOutport1_Batch = vld1q_s32(Assignment_DefaultOutport1 + batchIndex);
            int32x4_t Add2_DefaultOutport1_Batch = {0};
            Add2_DefaultOutport1_Batch = vaddq_s32(Assignment_DefaultOutport1_Batch, Switch4_DefaultOutport1_Batch1);
            int32x4_t Product2_DefaultOutport1_Batch = {0};
            int32x4_t rate2_DefaultOutport1_BatchConvert = vcvtq_s32_f32(rate2_DefaultOutport1_Batch);
            Product2_DefaultOutport1_Batch = vmulq_s32(rate2_DefaultOutport1_BatchConvert, Add2_DefaultOutport1_Batch);

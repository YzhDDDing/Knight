...
void system_869_Update(struct system_869_state* self, int FindP) {
    ...
    for (int i = 0; i < 256; i++) {
        ...
        for (batchIndex5 = 0; batchIndex5 < 256; batchIndex5++) {
            Product2_DefaultOutport1[batchIndex5] = Add1_DefaultOutport1[batchIndex5] * T1_DefaultOutport1;
        }
        int batchIndex6;
        ...
        for (batchIndex7 = 0; batchIndex7 < 256; batchIndex7++) {
            Subtract2_DefaultOutport1[batchIndex7] = Product2_DefaultOutport1[batchIndex7] - key1_DefaultOutport1;
        }

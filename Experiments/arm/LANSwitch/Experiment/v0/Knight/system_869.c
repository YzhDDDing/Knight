...
void system_869_Update(struct system_869_state* self, int FindP) {
    ...
    for (batchIndex4 = 0; batchIndex4 < 256; batchIndex4++) {
        Product2_DefaultOutport1[batchIndex4] = Add1_DefaultOutport1[batchIndex4] * T1_DefaultOutport1;
    }
    int batchIndex5;
    ...
    for (batchIndex6 = 0; batchIndex6 < 256; batchIndex6++) {
        Subtract2_DefaultOutport1[batchIndex6] = Product2_DefaultOutport1[batchIndex6] - key1_DefaultOutport1;
    }
    int batchIndex7;

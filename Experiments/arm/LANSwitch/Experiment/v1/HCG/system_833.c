...
void system_833_Update(struct system_833_state* self, int PortId, int FindE) {
    ...
    for (int i = 0; i < 256; i++) {
        ...
        float32x4_t T1_DefaultOutport1_Batch = vdupq_n_f32(T1_DefaultOutport1);
        int32x4_t key_DefaultOutport1_Batch = vdupq_n_s32(key_DefaultOutport1);
        float32x4_t key1_DefaultOutport1_Batch = vdupq_n_f32(key1_DefaultOutport1);
        int batchIndex = 0;
        for (batchIndex = 0;batchIndex < 256;batchIndex += 4) {
            ...
            int32x4_t T1_DefaultOutport1_BatchConvert = vcvtq_s32_f32(T1_DefaultOutport1_Batch);
            Product2_DefaultOutport1_Batch = vmulq_s32(Add1_DefaultOutport1_Batch, T1_DefaultOutport1_BatchConvert);
            ...
            int32x4_t key1_DefaultOutport1_BatchConvert = vcvtq_s32_f32(key1_DefaultOutport1_Batch);
            Subtract2_DefaultOutport1_Batch = vsubq_s32(Product2_DefaultOutport1_Batch, key1_DefaultOutport1_BatchConvert);

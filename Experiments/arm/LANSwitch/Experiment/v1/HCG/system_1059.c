...
void system_1059_Update(struct system_1059_state* self, int PortId, int TargetP, int m, int m2, int* Result, int* MSG) {
    ...
    int Constant5_DefaultOutport1 = 0;
    int Constant6_DefaultOutport1 = 0;
    ...
    bool CompareTo_Constant3_DefaultOutport1 = 0;
    bool CompareTo_Constant4_DefaultOutport1 = 0;
    bool CompareTo_Constant5_DefaultOutport1 = 0;
    int Switch5_DefaultOutport1 = 0;

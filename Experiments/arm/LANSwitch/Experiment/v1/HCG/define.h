...
extern int Data_StoreMemory1_Found_P;
...
extern int Data_StoreMemory1_Found_P_1;
...
extern int Data_StoreMemory1_Found_P_2;
extern int Data_StoreMemory2_Found_PT;
...
extern int PortPool_PortPool[256];
extern int PortPool1_PortPoolF[256];
extern int PortPool2_PortConfound[256];
extern int PortPool3_PortConfoundF[256];
extern int PortPool4_Bright[256];
extern int PortPool5_BrightF[256];
...
void system_942_Update(struct system_942_state* self, int* Result, int* MSG);
...
void system_1142_Update(struct system_1142_state* self, int FindP, int* Result, int* Out2);
void system_1150_Init(struct system_1150_state* self);
void system_1150_Update(struct system_1150_state* self, int* Result, int* Out2);
...
void system_714_Update(struct system_714_state* self, int PortId, int Arg1, int Arg2, int Arg3, int* Result, int* MSG);
void system_851_Init(struct system_851_state* self);
void system_851_Update(struct system_851_state* self, int* Result, int* MSG);
...
void system_893_Update(struct system_893_state* self, int PortId, int* Out1);
void system_886_Init(struct system_886_state* self);
void system_886_Update(struct system_886_state* self, int* Result);
...
void system_726_Update(struct system_726_state* self, int* Result, int* MSG);
...
void system_744_Update(struct system_744_state* self, int PortId, bool* Out1);
...
void system_797_Update(struct system_797_state* self, int PortId, int FindE, int* Result, int* MSG);
...
void system_1017_Update(struct system_1017_state* self, int* Result, int* MSG);
...
void system_1032_Update(struct system_1032_state* self, int* Result);
void system_1059_Init(struct system_1059_state* self);
void system_1059_Update(struct system_1059_state* self, int PortId, int TargetP, int m, int m2, int* Result, int* MSG);

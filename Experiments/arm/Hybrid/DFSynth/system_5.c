#include "define.h"
double Data_StoreMemory_default_hp1;
double Data_StoreMemory1_default_hp2;
double Data_StoreMemory2_default_hp3;
double Data_StoreMemory3_default_lp1;
double Data_StoreMemory4_default_lp2;
double Data_StoreMemory5_default_lp3;
                     ...
                     double signal_l2[32], double signal_l3[32])
{
    ...
    system_123_Update(&system_123_instance, signal1, signal2, signal3, HighPass_signal_h1, HighPass_signal_h2,
                      HighPass_signal_h3);
    system_134_Update(&system_134_instance, signal1, signal2, signal3, LowPass_signal_l1, LowPass_signal_l2,
                      LowPass_signal_l3);
    int batchIndex;

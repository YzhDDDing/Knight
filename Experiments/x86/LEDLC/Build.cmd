...
mkdir outSTCG
mkdir outSTCG\Temp
D:\LAB\MBD\CodeGenerator\exe\ILTranslator\ILTranslator.exe -i "%ModelIL%" -o "outSTCG" -config "%ModelConfig%" -c false -p false -v false -b true -l cbmc -g true -ca %para_ca%
D:\LAB\MBD\CodeGenerator\exe\ILTranslator\ILTranslator.exe -i "%ModelIL%" -o "outSTCG" -config "%ModelConfig%" -c true -l tcg_state_search -ca %para_ca%
cd outSTCG
...
mkdir outFuzz
D:\LAB\MBD\CodeGenerator\exe\ILTranslator\ILTranslator.exe -i "%ModelIL%" -o "outFuzz" -config "%ModelConfig%" -c false -l libfuzzer -id true -ic true
cd outFuzz
call Build.bat
...
mkdir outHybrid
D:\LAB\MBD\CodeGenerator\exe\ILTranslator\ILTranslator.exe -i "%ModelIL%" -o "outHybrid" -c true -l tcg_hybrid
cd outHybrid
g++ -O2 *.cpp -Wl,--stack=104857600
cd ..

    ...
    for (int i = 0; i < 64; i++) {
        ...
        if (Assignment_init == 0) {
            ...
            for (batchIndex = 0;batchIndex < 64;batchIndex += 4) {
                ...
                (Assignment_DefaultOutport1 + batchIndex)[0] = ((int*)&Data_StoreRead1_DefaultOutport1_Batch)[0];
                (Assignment_DefaultOutport1 + batchIndex)[1] = ((int*)&Data_StoreRead1_DefaultOutport1_Batch)[1];
                (Assignment_DefaultOutport1 + batchIndex)[2] = ((int*)&Data_StoreRead1_DefaultOutport1_Batch)[2];
                (Assignment_DefaultOutport1 + batchIndex)[3] = ((int*)&Data_StoreRead1_DefaultOutport1_Batch)[3];
            }
        }
        ...
        __m128i Data_StoreRead_DefaultOutport1_Batch = _mm_set1_epi32(Data_StoreRead_DefaultOutport1);
        ...
        for (batchIndex = 0;batchIndex < 64;batchIndex += 4) {
            ...
            Add_DefaultOutport1_Batch = _mm_add_epi32(Assignment_DefaultOutport1_Batch, Data_StoreRead_DefaultOutport1_Batch);
            __m128i Product_DefaultOutport1_Batch = {0};
            __m128i delta_DefaultOutport1_BatchConvert = _mm_cvtps_epi32(delta_DefaultOutport1_Batch);
            Product_DefaultOutport1_Batch = _mm_mul_epi32(Add_DefaultOutport1_Batch, delta_DefaultOutport1_BatchConvert);

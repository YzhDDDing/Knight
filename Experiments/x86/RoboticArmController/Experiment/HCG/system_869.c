...
void system_869_Update(struct system_869_state* self, int FindP) {
    ...
    for (int i = 0; i < 128; i++) {
        ...
        __m128i FindP_Batch = _mm_set1_epi32(FindP);
        ...
        for (batchIndex = 0;batchIndex < 128;batchIndex += 4) {
            ...
            Add_DefaultOutport1_Batch = _mm_add_epi32(Constant_DefaultOutport1_Batch, Assignment_DefaultOutport1_Batch);
            __m128i Add1_DefaultOutport1_Batch = {0};
            Add1_DefaultOutport1_Batch = _mm_add_epi32(Assignment1_DefaultOutport1_Batch, FindP_Batch);

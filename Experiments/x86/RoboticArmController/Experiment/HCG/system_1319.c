...
void system_1319_Update(struct system_1319_state* self, int FindP, int P1, int P2, int P3) {
    ...
    for (int i = 0; i < 128; i++) {
        ...
        __m128i Switch4_DefaultOutport1_Batch1 = _mm_set1_epi32(Switch4_DefaultOutport1);
        __m128 rate_DefaultOutport1_Batch = _mm_set1_ps(rate_DefaultOutport1);
        int batchIndex = 0;
        for (batchIndex = 0;batchIndex < 128;batchIndex += 4) {
            ...
            Add_DefaultOutport1_Batch = _mm_add_epi32(Assignment_DefaultOutport1_Batch, Switch4_DefaultOutport1_Batch1);
            __m128i Product_DefaultOutport1_Batch = {0};
            __m128i rate_DefaultOutport1_BatchConvert = _mm_cvtps_epi32(rate_DefaultOutport1_Batch);
            Product_DefaultOutport1_Batch = _mm_mul_epi32(Add_DefaultOutport1_Batch, rate_DefaultOutport1_BatchConvert);

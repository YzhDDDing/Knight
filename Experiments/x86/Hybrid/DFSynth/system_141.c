#include "define.h"
struct system_141_state system_141_instance;
...
void system_141_Update(struct system_141_state *self, double signal1[32], double signal_l1[32])
{
    ...
    double *Data_StoreRead1_DefaultOutport1 = &(Data_StoreMemory6_S1[0]);
    ...
    for (int i = 0; i < 32; i++)
    {
        Data_StoreRead_DefaultOutport1 = Data_StoreMemory3_default_lp1;
        ...
        {
            signal_l1[batchIndex3] = Switch_DefaultOutport1[batchIndex3];
        }
    }
}
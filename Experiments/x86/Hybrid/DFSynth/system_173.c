#include "define.h"
struct system_173_state system_173_instance;
...
{
    double Data_StoreRead_DefaultOutport1 = 0;
    double *Data_StoreRead1_DefaultOutport1 = &(Data_StoreMemory8_S3[0]);
    int For_Iterator_DefaultOutport1 = -1;
    double delta_DefaultOutport1 = 0;
    double dt_DefaultOutport1 = 0;
    double Selector_DefaultOutport1 = 0;
    double Selector1_DefaultOutport1 = 0;
    double Add_DefaultOutport1 = 0;
    double Product1_DefaultOutport1 = 0;
    ...
    for (int i = 0; i < 32; i++)
    {
        Data_StoreRead_DefaultOutport1 = Data_StoreMemory5_default_lp3;
        For_Iterator_DefaultOutport1++;
        delta_DefaultOutport1 = 2.6;
        ...
        Product1_DefaultOutport1 = Selector1_DefaultOutport1 * Add_DefaultOutport1;
        ...
        {
            Product_DefaultOutport1[batchIndex1] = (double)delta_DefaultOutport1 * Add1_DefaultOutport1[batchIndex1];
        }
        int batchIndex2;
        for (batchIndex2 = 0; batchIndex2 < 32; batchIndex2++)
        {
            Divide_DefaultOutport1[batchIndex2] = Product_DefaultOutport1[batchIndex2] * (double)delta_DefaultOutport1;
        }

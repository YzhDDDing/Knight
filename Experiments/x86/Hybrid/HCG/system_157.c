#include "define.h"
struct system_157_state system_157_instance;
...
void system_157_Update(struct system_157_state *self, double signal2[32], double signal_l2[32])
{
    ...
    for (int i = 0; i < 32; i++)
    {
        Data_StoreRead_DefaultOutport1 = Data_StoreMemory4_default_lp2;
        ...
        {
            signal_l2[batchIndex3] = Switch_DefaultOutport1[batchIndex3];
        }
    }
}
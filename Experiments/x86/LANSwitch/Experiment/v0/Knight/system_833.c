...
void system_833_Update(struct system_833_state* self, int PortId, int FindE) {
    ...
    for (batchIndex2 = 0; batchIndex2 < 256; batchIndex2++) {
        Product3_DefaultOutport1[batchIndex2] = Subtract3_DefaultOutport1 * Assignment1_DefaultOutport1[batchIndex2];
    }
    int batchIndex3;
    for (batchIndex3 = 0; batchIndex3 < 256; batchIndex3++) {
        Product1_DefaultOutport1[batchIndex3] = Subtract1_DefaultOutport1 * Assignment_DefaultOutport1[batchIndex3];
    }
    int batchIndex4;
    for (batchIndex4 = 0; batchIndex4 < 256; batchIndex4++) {
        Product2_DefaultOutport1[batchIndex4] = (int)(Add1_DefaultOutport1[batchIndex4] * (int)T1_DefaultOutport1);
    }
    int batchIndex5;
    for (batchIndex5 = 0; batchIndex5 < 256; batchIndex5++) {
        Product_DefaultOutport1[batchIndex5] = T_DefaultOutport1 * Add_DefaultOutport1[batchIndex5];
    }
    int batchIndex6;
    for (batchIndex6 = 0; batchIndex6 < 256; batchIndex6++) {
        Subtract2_DefaultOutport1[batchIndex6] = (int)(Product2_DefaultOutport1[batchIndex6] - (int)key1_DefaultOutport1);
    }
    int batchIndex7;
    for (batchIndex7 = 0; batchIndex7 < 256; batchIndex7++) {
        Subtract_DefaultOutport1[batchIndex7] = Product_DefaultOutport1[batchIndex7] - key_DefaultOutport1;
    }

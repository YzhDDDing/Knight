    ...
    for (int i = 0; i < 256; i++) {
        ...
        if (Assignment1_init == 0) {
            ...
            for (batchIndex = 0;batchIndex < 256;batchIndex += 4) {
                ...
                (Assignment1_DefaultOutport1 + batchIndex)[0] = ((int*)&Data_StoreRead2_DefaultOutport1_Batch)[0];
                (Assignment1_DefaultOutport1 + batchIndex)[1] = ((int*)&Data_StoreRead2_DefaultOutport1_Batch)[1];
                (Assignment1_DefaultOutport1 + batchIndex)[2] = ((int*)&Data_StoreRead2_DefaultOutport1_Batch)[2];
                (Assignment1_DefaultOutport1 + batchIndex)[3] = ((int*)&Data_StoreRead2_DefaultOutport1_Batch)[3];
            }
        }
        ...
        __m128i T1_DefaultOutport1_Batch = _mm_set1_epi32(T1_DefaultOutport1);
        ...
        for (batchIndex = 0;batchIndex < 256;batchIndex += 4) {
            ...
            Product2_DefaultOutport1_Batch = _mm_mul_epi32(Add1_DefaultOutport1_Batch, T1_DefaultOutport1_Batch);
            ...
            Subtract2_DefaultOutport1_Batch = _mm_sub_epi32(Product2_DefaultOutport1_Batch, key1_DefaultOutport1_Batch);
